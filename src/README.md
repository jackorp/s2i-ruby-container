Ruby {{ spec.stream }} container image
========================
This container image includes Ruby {{ spec.stream }} as a [S2I](https://github.com/openshift/source-to-image) base image for your Ruby {{ spec.stream }} applications.
...
Ruby {{ spec.stream }} available as container is a base platform for
...
in Openshift can be achieved with the following step:
    ...
    ```
    oc new-app ruby:{{ spec.stream }}~https://github.com/sclorg/rails-ex.git
    ```
